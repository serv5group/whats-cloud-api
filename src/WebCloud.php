...
* -----------------------------------------------------------------------------------------
* DOCUMENTION
*   use App\Bll\WebCloud;
*   $needbot = WebCloud::accessToken("6444f5e86558f");
*   $connect = $needbot->connect();
*   $qcode = $connect->getQrCode()->save(public_path("uploads/maxmaxmaxamxaxm2023222.png"));
*   $webhook =  $needbot->qrStatus();
*   $message = $needbot->to("201007668628")->message("welcome mohamed hesham test api")->send();
* _________________________________________________________________________________________
* -----------------------------------------------------------------------------------------
**/
